...
public class Supplier implements Viewable {
    ...
    public void viewByCategory(String cat){
       ...
       for(int i=0;i<myProducts.size();i++)
       {
        ...
        {
            System.out.println((x)+": "+myProducts.get(i)+"  Items left : "+myProducts.get(i).getStock());
            x++;
        }
       }
    }
    public void viewAllProducts(){
        for(int i=0;i<myProducts.size();i++)
        {
            System.out.println((i+1)+": "+ "Name: "+myProducts.get(i).getName()+" price: "+myProducts.get(i).getPrice()+"  Items left : "+myProducts.get(i).getStock());
        }
}
}